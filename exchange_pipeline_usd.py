...
def get_data():
    ...
    # urls
    url_1 = f"https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@{dt}/v1/currencies/usd.json"
    url_2 = f'https://{dt}.currency-api.pages.dev/v1/currencies/usd.json'
    try:
...
def extract_store_rate(data, connection, cursor):
    ...
    for k, v in data.items():
        query = """
        INSERT INTO exchange_rate_usd(curr_code, rate, ex_date) 
        VALUES (%s, %s, %s)
        """
